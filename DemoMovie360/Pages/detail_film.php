...
<body>
    ...
    ?>
    <div class="container">
    <div class="container p-2 text-white-50 text-center mt-5 rounded shadow" 
    style="background: linear-gradient(90deg, rgba(0,0,0,0.7315301120448179) 7%, rgba(9,32,31,0.9023984593837535) 33%, rgba(34,8,28,0.8883928571428571) 73%, rgba(0,0,0,0.7455357142857143) 93%);">
